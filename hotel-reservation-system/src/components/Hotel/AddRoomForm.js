...
export default function AddHotelForm({hotelId,room,handleClose,callAlert,callUpdateAlert,toServiceSection,addRoomToTable}) {
  ...
  const initialValues = {
    roomNumber: room===undefined ? '' : room.name,
  ...
  const validationSchema = Yup.object().shape({
    ...
    paymentPerDay: Yup.string().required("payment per day is required")
  })
