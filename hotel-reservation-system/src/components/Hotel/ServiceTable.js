...
export default function ServiceTable({hotelId}){
 ...
 useEffect(() => {
  const loadServices = async () => {
    await  API
    .get('/services/'+hotelId+'/pages?PageNumber='+ pageForRequest + '&PageSize=' + rowsPerPage)
        ...
        <BaseDeleteDialog
           open={openDeleteDialog}
            handleCloseDeleteDialog={handleCloseDeleteDialog}
             ...
             ></BaseDeleteDialog>
             <BaseAlert open={addAlertOpen} handleClose = {handleCloseAlert} message = {'service added successfully'}></BaseAlert>
             <BaseAlert open ={deleteAlertOpen} handleClose ={handleCloseAlert} message = {'service deleted succesfully'}></BaseAlert>
             <BaseAlert open ={updateAlertOpen} handleClose ={handleCloseAlert} message = {'service updated succesfully'}></BaseAlert>
          </>
        );
}